...
window.configure(background='#789874')
...
message3 = tk.Label(window, text="Face Recognition Based FaceTally And Snap Attendence" ,fg="white",bg="#008080" ,width=59 ,height=1,font=('comic', 29, ' bold '))
...
datef = tk.Label(frame4, text = day+"-"+mont[month]+"-"+year+"   |  ", fg="#ff61e5",bg="#2d420a" ,width=60 ,height=1,font=('comic', 20, ' bold '))
datef.pack(fill='both',expand=1)

clock = tk.Label(frame3,fg="#FFD700",bg="#2d420a" ,width=60 ,height=1,font=('comic', 22, ' bold '))
...
message1 = tk.Label(frame2, text="1)Take Images  >>>  2)Save Profile" ,bg="#c79cff" ,fg="black"  ,width=39 ,height=1, activebackground = "#FFD700" ,font=('comic', 15, ' bold '))
...
clearButton = tk.Button(frame2, text="Clear", command=clear  ,fg="black"  ,bg="#FFA500"  ,width=11 ,activebackground = "white" ,font=('comic', 11, ' bold '))
clearButton.place(x=335, y=86)
clearButton2 = tk.Button(frame2, text="Clear", command=clear2  ,fg="black"  ,bg="#FFA500"  ,width=11 , activebackground = "white" ,font=('comic', 11, ' bold '))
clearButton2.place(x=335, y=172)    
takeImg = tk.Button(frame2, text="Take Images", command=TakeImages  ,fg="white"  ,bg="#800080"  ,width=34  ,height=1, activebackground = "white" ,font=('comic', 15, ' bold '))
takeImg.place(x=30, y=300)
trainImg = tk.Button(frame2, text="Save Profile", command=psw ,fg="white"  ,bg="#800080"  ,width=34  ,height=1, activebackground = "white" ,font=('comic', 15, ' bold '))
trainImg.place(x=30, y=380)
trackImg = tk.Button(frame1, text="Start Detecting", command=TrackImages  ,fg="black"  ,bg="#800080"  ,width=35  ,height=1, activebackground = "white" ,font=('comic', 15, ' bold '))
trackImg.place(x=30,y=50)
quitWindow = tk.Button(frame1, text="Quit", command=window.destroy  ,fg="black"  ,bg="#FFA500"  ,width=35 ,height=1, activebackground = "white" ,font=('comic', 15, ' bold '))
